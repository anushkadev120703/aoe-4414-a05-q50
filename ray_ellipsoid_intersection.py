...
#  finds itnersection point between a ray and the earth reference ellipsoid
...
# c_l_x: x-component offset of the ray origin 
# c_l_y: y-component offset of the ray origin 
# c_l_z: z-component offset of the ray origin 

# Output:
#  prints the x-component, y-component and z-component of intersection point if it exists 
#
